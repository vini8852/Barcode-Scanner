...
export class AppComponent implements AfterViewInit {
  ...
  private catalogue: Article[] = [
    {
      name: 'Product 1',
      ean: '7601234567890',
      image: 'assets/classy_crab_red.png',
      price: 10,
    },
    {
      name: 'Product 2',
      ean: '7601234561232',
      image: 'assets/classy_crab_blue.png',
      price: 10,
    },
    {
      name: 'Product 1',
      ean: '7601234564561',
      image: 'assets/classy_crab_gold.png',
      price: 50,
    },
  ];
  ...
  onBarcodeScanned(code: string) {
    // To ignore duplicates for an interval of 1.5 seconds
